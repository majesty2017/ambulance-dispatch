      ...
      <div class="card card-congratulations">
        <div class="card-body text-center">
          ...
          <div class="text-center">
            <h1 class="mb-1 text-white"><span id="greetings"></span> {{ auth()->user()->first_name . ' ' . auth()->user()->last_name }},</h1>
            <p class="card-text m-auto w-75">
              Welcome to, <strong>Ambulance Dispatch Management System</strong>. We hope this system help solve your problems.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <h2 class="font-weight-bolder mt-1" id="count_ambulances">0</h2>
          <p class="card-text">Ambulances</p>
        </div>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <h2 class="font-weight-bolder mt-1" id="count_requests">0</h2>
          <p class="card-text">Requested Ambulances</p>
        </div>
...
@section('page-script')
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $.ajax({
        url: '/dashboard/count_ambulances',
        type: 'post',
        data: {_token: _token},
        success: function (res) {
          $('#count_ambulances').html(res)
        }
      })
      $.ajax({
        url: '/dashboard/count_request',
        type: 'post',
        data: {_token: _token},
        success: function (res) {
          $('#count_requests').html(res)
        }
      })
    })
  </script>
