<!-- Modal -->
<div class="modal fade" id="view-user-modal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
            ...
            <div class="modal-body">
                <form method="post">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="custom-file mb-5">
                                    <div id="vv_load_profile_picture" class="mb-1"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="font-weight-bolder" for="rank">Rank</label>
                                <div id="v_rank"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
