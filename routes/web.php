...
use App\Http\Controllers\AmbulanceInfoController;
...
Route::get('/home', [DashboardController::class,'dashboardAnalytics'])->name('dashboard-ecommerce');
...
Route::group(['prefix' => 'dashboard'], function () {
  ...
  Route::post('count_ambulances', [DashboardController::class,'count_ambulances'])->name('count-ambulances');
  Route::post('count_request', [DashboardController::class,'count_request'])->name('count-request');
});
/* Route Dashboards */
...
Route::group(['prefix' => 'user'], function () {
  ...
  Route::get('/user-lists', [UserController::class,'users']);
  Route::post('/user-data', [UserController::class,'show']);
  Route::post('/user-create', [UserController::class,'store'])->name('user.store');
  Route::post('/user-update', [UserController::class,'update'])->name('user.update');
  Route::delete('/user-destroy/{id}', [UserController::class,'destrory'])->name('user.destroy');
});
/* Route User */

/* Route Ambulance */
Route::group(['prefix' => 'requests'], function () {
  Route::get('/', [ERequestController::class,'index'])->name('request-list');
  Route::get('/request-lists', [ERequestController::class,'requests']);
  Route::post('/request-data', [ERequestController::class,'show']);
  Route::post('/request-create', [ERequestController::class,'store'])->name('request.store');
  Route::post('/request-update', [ERequestController::class,'update'])->name('request.update');
  Route::delete('/request-destroy/{id}', [ERequestController::class,'destrory'])->name('request.destroy');
});
...
Route::group(['prefix' => 'driver'], function () {
   Route::get('/', [DriverInfoController::class, 'index'])->name('driver-index');
   Route::get('/driver-lists', [DriverInfoController::class, 'drivers'])->name('driver-list');
   Route::post('/routes', [DriverInfoController::class, 'get_routes'])->name('driver.routes');
   Route::post('/create', [DriverInfoController::class, 'store'])->name('driver.create');
   Route::post('/driver-data', [DriverInfoController::class, 'show'])->name('driver.show');
   Route::post('/update', [DriverInfoController::class, 'update'])->name('driver.update');
   Route::delete('/destroy/{id}', [DriverInfoController::class, 'destrory'])->name('driver.delete');
});
/* Route driver info */
...
Route::group(['prefix' => 'routes'], function () {
   ...
   Route::get('/routes-lists', [RouteController::class, 'routes'])->name('routes-list');
   Route::post('/create', [RouteController::class, 'store'])->name('routes.create');
   Route::post('/routes-data', [RouteController::class, 'show'])->name('routes.show');
   Route::post('/update', [RouteController::class, 'update'])->name('routes.update');
   Route::delete('/destroy/{id}', [RouteController::class, 'destrory'])->name('routes.delete');
});
/* Route routes */

/* Route ambulance */
Route::group(['prefix' => 'ambulance'], function () {
   Route::get('/', [AmbulanceInfoController::class, 'index'])->name('ambulance-index');
   Route::get('/ambulance-lists', [AmbulanceInfoController::class, 'ambulances'])->name('ambulance-list');
   Route::post('/drivers', [AmbulanceInfoController::class, 'drivers'])->name('ambulance.drivers');
   Route::post('/create', [AmbulanceInfoController::class, 'store'])->name('ambulance.create');
   Route::post('/ambulance-data', [AmbulanceInfoController::class, 'show'])->name('ambulance.show');
   Route::post('/update', [AmbulanceInfoController::class, 'update'])->name('ambulance.update');
   Route::delete('/destroy/{id}', [AmbulanceInfoController::class, 'destroy'])->name('ambulance.delete');
});
/* Route ambulance */

/* Route driver_status */
Route::group(['prefix' => 'driver_status'], function () {
   Route::get('/', [DriverStatusController::class, 'index'])->name('driver-status');
   Route::get('/driver_status-lists', [DriverStatusController::class, 'driver_statuses'])->name('driver_status-list');
   Route::post('/create', [DriverStatusController::class, 'store'])->name('driver_status.create');
   Route::post('/driver_status-data', [DriverStatusController::class, 'show'])->name('driver_status.show');
    Route::post('/driver-status', [DriverStatusController::class, 'driver_status'])->name('dispatch_status.status');
   Route::post('/update', [DriverStatusController::class, 'update'])->name('driver_status.update');
   Route::delete('/destroy/{id}', [DriverStatusController::class, 'destroy'])->name('driver_status.delete');
});
/* Route driver_status */

/* Route dispatch_status */
Route::group(['prefix' => 'dispatch_status'], function () {
   Route::get('/', [DispatchStatusController::class, 'index'])->name('dispatch-status');
   Route::get('/dispatch_status-lists', [DispatchStatusController::class, 'dispatch_statuses'])->name('dispatch_status-list');
   Route::post('/create', [DispatchStatusController::class, 'store'])->name('dispatch_status.create');
   Route::post('/admins', [DispatchStatusController::class, 'admins'])->name('dispatch_status.admins');
   Route::post('/requests', [DispatchStatusController::class, 'requests'])->name('dispatch_status.requests');
   Route::post('/dispatch_status-data', [DispatchStatusController::class, 'show'])->name('dispatch_status.show');
   Route::post('/update', [DispatchStatusController::class, 'update'])->name('dispatch_status.update');
   Route::delete('/destroy/{id}', [DispatchStatusController::class, 'destroy'])->name('dispatch_status.delete');
});
/* Route driver_status */
...
Route::group(['prefix' => 'page'], function () {
  ...
  Route::post('profile', [PagesController::class,'update_profile'])->name('update-profile');
